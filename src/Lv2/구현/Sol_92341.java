...
public class Sol_92341 {
    public static int[] solution(int[] fees, String[] records) {
        ...
        Map<String, Integer> total = getStringIntegerMap(records);
    ...
    private static Map<String, Integer> getStringIntegerMap(String[] records) {
        ...
        for (String r : records) {
            ...
            if ("IN".equals(action)) {
                ...
                total.put(car, total.getOrDefault(car, 0) + (time - in));
            }
        }
        ...
        for (Map.Entry<String, Integer> e : inTime.entrySet()) {
            String car = e.getKey();
            int in = e.getValue();
            total.put(car, total.getOrDefault(car, 0) + (endOfDay - in));
        }
        return total;
    }
    ...
    public static void main(String[] args) {
        ...
        System.out.println(Arrays.toString(solution(fees, records))); // [14600, 34400, 5000]
    }
