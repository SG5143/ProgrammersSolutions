/*
    ...
    빈 병 n개를 가져다주면 몇 병을 받을 수 있는지 계산하는 문제입니다. 기존 콜라 문제와 마찬가지로,
    보유 중인 빈 병이 a개 미만이면, 추가적으로 빈 병을 받을 순 없습니다. 상빈이는 열심히 고심했지만,
...
public class Sol_132267 {
    public int solution(int a, int b, int n) {
        ...
        while (n >= a) {
            int exchanged = (n / a) * b; // 교환해서 받은 콜라 병 수
            answer += exchanged;
            n = (n % a) + exchanged; // 남은 병 + 마신 콜라에서 나온 병
        }
